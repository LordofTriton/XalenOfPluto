...
const Actions = {
    ...
    "*takes off your pants*": [
        ...
        "*lets you*",
        "*shyly* Turn off the lights first..."
    ],
    "*penetrates you*": [
        "Oh my God 😳",
        "*moans*",
...
const Override = {Identity, Actions, tautology, copycat, fallback, gibberish, convoTrigger, convoStarter, jokeTrigger, jokes, allowedGibberish, loneSense}
